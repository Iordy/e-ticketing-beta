        ...
        while(!(option.equals( "12"))){
            ...
            switch (option) {
                 case "1":
                    ...
                    String basicTicketPrice = scanner.nextLine();
                    double intBasicTicketPrice = Double.parseDouble(basicTicketPrice);

                    System.out.println("Enter the number of tickets:");
                    String numberOfTickets = scanner.nextLine();
                    int intNumberOfTickets = Integer.parseInt(numberOfTickets);

                    eventManager.registerEvent(scanner, eventName, eventDate, eventLocation, intBasicTicketPrice, intNumberOfTickets);
                    break;
                case "2":
